...
def create_ImageEncoder(model_name='resnet50', pretrained=True, frozen=True):
    ...
    if model_name == 'resnet50':
        ...
        # Path to local UNI weights (cell_SpatialEx fork uses /home/sb202604/UNI).
        # The original source repo had the first author's home path hard-coded.
        local_dir = "/home/sb202604/UNI/"
