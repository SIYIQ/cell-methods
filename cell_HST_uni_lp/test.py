"""cell_HST_uni_lp test script: compute per-direction and aggregated MSE/MAE.
...
# Reuse predict.py's data loading and utils.extract_gene_expr logic.
...
def main():
    ap = argparse.ArgumentParser(
        description="Aggregate cell_HST_uni_lp predictions and compute MSE/MAE."
    )
